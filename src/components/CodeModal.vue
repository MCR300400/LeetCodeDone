...
<template>
  ...
  >
    <div
      class="w-full max-w-4xl max-h-[90vh] bg-leetcode-card border border-leetcode-border rounded-2xl shadow-2xl flex flex-col overflow-hidden animate-in fade-in zoom-in-95 duration-200"
    >
      <!-- Modal Header -->
      <div class="p-4 sm:p-6 border-b border-leetcode-border flex items-start justify-between gap-4 bg-leetcode-card/90">
        <div>
        ...
        <button
          type="button"
          @click="emit('close')"
          class="p-2 rounded-lg text-slate-400 hover:text-white hover:bg-leetcode-border/60 transition-colors"
          title="Chiudi (Esc)"
        >
          <X class="w-5 h-5" />
        </button>
      ...
      <div
        ...
        class="px-6 py-2.5 bg-leetcode-bg border-b border-leetcode-border flex items-center gap-2 text-xs font-mono"
      >
        <span class="text-slate-500 mr-1">Approcci disponibili:</span>
        <button
          ...
          class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg border transition-all"
        >
          <AlertTriangle v-if="sol.isSlow" class="w-3.5 h-3.5 text-amber-400" />
      ...
      <div class="px-4 sm:px-6 py-2.5 bg-leetcode-bg/80 border-b border-leetcode-border flex flex-wrap items-center justify-between gap-3 text-xs font-mono">
        <div class="flex items-center gap-2 text-slate-400">
          <FileCode class="w-3.5 h-3.5 text-leetcode-orange" />
          <span class="text-slate-300">{{ currentSolution.filePath }}</span>
          <span class="text-slate-600">•</span>
          <span>{{ currentSolution.linesCount }} righe</span>
        </div>
        ...
        <div class="flex items-center gap-2">
          ...
          <button
            type="button"
            @click="copyCode"
            class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-leetcode-border bg-leetcode-card hover:bg-leetcode-cardHover text-slate-200 text-xs font-mono transition-colors"
          >
          ...
          <a
            ...
            class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-leetcode-orange/30 bg-leetcode-orange/10 hover:bg-leetcode-orange/20 text-leetcode-orange text-xs font-mono transition-colors"
          >
            <span>LeetCode</span>
      ...
      <div class="flex-1 overflow-auto p-4 sm:p-6 bg-[#0B0F17] font-mono text-xs sm:text-sm">
